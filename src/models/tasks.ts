...
const TaskSchema: Schema<ITask> = new Schema<ITask>({
  ...
  const TaskCompletionSchema: Schema<ITaskCompletion> = new Schema<ITaskCompletion>({
  ...
  export const TaskCompletion: Model<ITaskCompletion> = model<ITaskCompletion>('TaskCompletion', TaskCompletionSchema);
